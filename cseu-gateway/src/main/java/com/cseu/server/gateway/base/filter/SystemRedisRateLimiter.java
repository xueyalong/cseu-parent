...
import com.cseu.server.gateway.config.ReteLimiterConfig;
...
/**
 * @title: RateLimiterGatewayFilterFactory
 * @projectName gateway
 * @description: 限流
 * @author: yalong.xue
 * @date 2019-06-0820:37
 */
@Slf4j
public class SystemRedisRateLimiter extends AbstractRateLimiter<SystemRedisRateLimiter.Config> implements ApplicationContextAware {
    ...
    private ReteLimiterConfig rateLimiterConf;

    @Override
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        this.rateLimiterConf = applicationContext.getBean(ReteLimiterConfig.class);
    }
